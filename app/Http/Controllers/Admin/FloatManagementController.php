...
class FloatManagementController extends Controller
{
    public function index()
    {
        ...
        return view('admin.floatManagements.index', compact('floatManagements'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.floatManagements.create', compact('users'));
    }
    ...
    public function store(StoreFloatManagementRequest $request)
    {
        ...
        return redirect()->route('admin.float-managements.index');
    }
    ...
    public function edit(FloatManagement $floatManagement)
    {
        ...
        return view('admin.floatManagements.edit', compact('users', 'floatManagement'));
    }
    ...
    public function show(FloatManagement $floatManagement)
    {
        ...
        return view('admin.floatManagements.show', compact('floatManagement'));
    }
