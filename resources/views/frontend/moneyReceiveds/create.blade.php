    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.money-receiveds.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="date_received">{{ trans('cruds.moneyReceived.fields.date_received') }}</label>
                            <input class="form-control date" type="text" name="date_received" id="date_received" value="{{ old('date_received') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="transaction_ref" id="transaction_ref" value="{{ old('transaction_ref', '') }}">
