...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fleet-datas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('journey_date') ? 'is-invalid' : '' }}" type="text" name="journey_date" id="journey_date" value="{{ old('journey_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_reg_no') ? 'is-invalid' : '' }}" type="text" name="vehicle_reg_no" id="vehicle_reg_no" value="{{ old('vehicle_reg_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_paid_out') ? 'is-invalid' : '' }}" type="number" name="amount_paid_out" id="amount_paid_out" value="{{ old('amount_paid_out', '') }}" step="0.01" required>
